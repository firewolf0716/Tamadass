...
if ( ! class_exists( 'ACFIM_plugin' ) ) {
	class ACFIM_plugin {
		...
		public function admin_menu() {
			$page_hook_suffix = add_submenu_page( 'tools.php', esc_html__( 'ACF import/export', 'surveys-plugin' ), esc_html__( 'ACF import/export', 'surveys-plugin' ), 'manage_options', 'acf-import-export', array($this, 'admin_page' ) ); 
			add_action( 'admin_print_scripts-' . $page_hook_suffix, array( $this, 'admin_enqueue_scripts' ) );
		}


		public function admin_enqueue_scripts() {	
			wp_enqueue_style( 'acfim-styles', $this->plugin_url . '/css/styles.css?' . time(), array(), $this->plugin_version );
		}
